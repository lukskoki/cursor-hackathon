  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.breakdownSection}>
        <SubRating label="Reliability" value={review.reliability} />
        <SubRating label="Communication" value={review.communication} />
        <SubRating label="Effort" value={review.effort} />
      </View>
    </View>
  );
}
        ...
        ListEmptyComponent={
          <View style={styles.emptyWrap}>
            ...
            <Text style={styles.emptyMsg}>
              Reviews from organizations will appear here after your volunteer
              work.
            </Text>
          </View>
        }
...
const styles = StyleSheet.create({
  ...
  subRatingLabel: { fontSize: 13, color: "#666", width: 110 },
